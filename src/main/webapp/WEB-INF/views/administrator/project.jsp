...
<body>
	...
	<div class="main-content">
		...
		<div style="text-align:center">
			...
			<div class="comment"
				style="width: 100%; height: 500px; border: 1px solid #fff; padding: 20px;">
				<!-- danh sách sản phẩm -->
						<table class="table table-striped" style="margin-top:10px">
							<thead>
								<tr>
									...
									<th scope="col">Sản phâm đã mua</th>
									<th scope="col">Ngày mua</th>
									
								</tr>
							</thead>
							<tbody>
								<c:forEach items="${saleOrderProducts }" var="saleOrderProducts" varStatus="loop">
									<tr>
										<th scope="row" width="5%">
											${loop.index + 1}
										</th>
										<td>
											${saleOrderProducts.id }
										</td>
										<td>
											${saleOrderProducts.product.title }
										</td>
										
										<td>
											${saleOrderProducts.createdDate }
										</td>
